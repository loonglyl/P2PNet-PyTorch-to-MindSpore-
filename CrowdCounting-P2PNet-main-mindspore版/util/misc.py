...
def all_gather(data):
    ...
    local_size = mindspore.Tensor([tensor.numel()])
    size_list = [mindspore.Tensor([0]) for _ in range(world_size)]
    allGather = ops.AllGather()
    size_list = allGather(tensor)
